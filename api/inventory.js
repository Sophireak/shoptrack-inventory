...
const DEFAULT_CATALOG = [
  ...
  {
    id: 'cs-sport-uniform',
    name: 'Unisex Sport Uniform Set',
    nameKh: 'ឈុតកីឡាសាលា (អាវយឺត + ខោកីឡា)',
    category: 'sport',
    priceKhr: 26000,
    priceUsd: 6.34,
    badge: 'សម្រាប់ប្រុស & ស្រី',
    image: 'https://images.unsplash.com/photo-1577471488278-16eec37ffcc2?w=700&auto=format&fit=crop&q=80',
    description: 'ឈុតកីឡាផ្លូវការប្រចាំសាលា អាវយឺតកីឡាពណ៌ទឹកប៊ិកលាយលឿង និងខោកីឡា យឺតស្រួលរត់លេង។',
    sizes: [
      { size: 'S', stock: 22 },
      { size: 'M', stock: 35 },
      { size: 'L', stock: 19 },
  ...
  },
  {
    ...
    description: 'ប្រអប់ជ័រការពារកាតសិស្ស និងខ្សែពាក់កពណ៌ខៀវមានព្រីនឈ្មោះ បឋមសិក្សា សម្តេចជាស៊ីម។',
    sizes: [
      { size: 'ពណ៌ខៀវ (Blue)', stock: 120 },
      { size: 'ពណ៌ក្រហម (Red)', stock: 45 }
    ]
  }
];
